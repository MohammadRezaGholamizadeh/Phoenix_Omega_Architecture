/****** Object:  Table [dbo].[ApplicationUsers]    Script Date: 2023-07-02 09:17:23 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  Table [dbo].[RoleClaims]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[Id] ASC
    ...
    GO
/****** Object:  Table [dbo].[ApplicationRoles]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[Id] ASC
    ...
    GO
/****** Object:  Table [dbo].[VerificationCodes]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[Id] ASC
    ...
    GO
/****** Object:  Table [dbo].[UserClaims]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[Id] ASC
    ...
    GO
/****** Object:  Table [dbo].[UserLogins]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[ProviderKey] ASC
    ...
    GO
/****** Object:  Table [dbo].[UserRoles]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[RoleId] ASC
    ...
    GO
/****** Object:  Table [dbo].[UserTokens]    Script Date: 2023-07-02 09:17:23 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[Name] ASC
    ...
    GO
ALTER TABLE [dbo].[ApplicationRoleClaims]  
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationRoleClaims_ApplicationRoles_RoleId] FOREIGN KEY([RoleId])
...
ALTER TABLE [dbo].[ApplicationRoleClaims] CHECK CONSTRAINT [FK_ApplicationRoleClaims_ApplicationRoles_RoleId]
    GO
ALTER TABLE [dbo].[ApplicationUserClaims]  
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationUserClaims_ApplicationUsers_UserId] FOREIGN KEY([UserId])
    REFERENCES [dbo].[ApplicationUsers] ([Id])
    ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ApplicationUserClaims] CHECK CONSTRAINT [FK_ApplicationUserClaims_ApplicationUsers_UserId]
    GO
ALTER TABLE [dbo].[ApplicationUserLogins]
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationUserLogins_ApplicationUsers_UserId] FOREIGN KEY([UserId])
    REFERENCES [dbo].[ApplicationUsers] ([Id])
    ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ApplicationUserLogins] CHECK CONSTRAINT [FK_ApplicationUserLogins_ApplicationUsers_UserId]
    GO
ALTER TABLE [dbo].[ApplicationUserRoles]  
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationUserRoles_ApplicationUsers_UserId] FOREIGN KEY([UserId])
    REFERENCES [dbo].[ApplicationUsers] ([Id])
    ON DELETE CASCADE
	GO
ALTER TABLE [dbo].[ApplicationUserRoles] CHECK CONSTRAINT [FK_ApplicationUserRoles_ApplicationUsers_UserId]
    GO
ALTER TABLE [dbo].[ApplicationUserRoles] 
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationUserRoles_ApplicationRoles_RoleId] FOREIGN KEY([RoleId])
    REFERENCES [dbo].[ApplicationRoles] ([Id])
    ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ApplicationUserRoles] CHECK CONSTRAINT [FK_ApplicationUserRoles_ApplicationRoles_RoleId]
    GO
ALTER TABLE [dbo].[ApplicationUserTokens]
    WITH CHECK ADD  CONSTRAINT [FK_ApplicationUserTokens_ApplicationUsers_UserId] FOREIGN KEY([UserId])
    REFERENCES [dbo].[ApplicationUsers] ([Id])
    ON DELETE CASCADE
GO
